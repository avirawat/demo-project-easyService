...
public class ContractorController {
	...
	ResponseEntity<String> assignMaintenance(@RequestBody Maintenance maintenance,
		...
		ResponseEntity<String> maintenanceResponse = new ResponseEntity<String>("Project Assigned", headers,
				HttpStatus.OK);
	...
	ResponseEntity<String> unAssignMaintenance(@RequestBody Maintenance maintenance) {
		...
		ResponseEntity<String> maintenanceResponse = new ResponseEntity<String>("Project Un-Assigned", headers,
				HttpStatus.OK);
		return maintenanceResponse;
	}
	...
	//http://localhost:8070/contractor-service/maintenance
	@GetMapping("/maintenance")
	List<Maintenance> getAllMaintenance(){
		return contractorService.getAllMaintenance();
	}
